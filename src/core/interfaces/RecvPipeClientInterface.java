...
/**
 * <p>An interface defining the server side end of the IncomingEmailPipe which connects to the mail server.</p>
 *
 * @see core.IncomingEmailPipe
 */
public abstract interface RecvPipeClientInterface
{
