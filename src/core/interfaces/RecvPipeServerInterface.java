...
/**
 * <p>An interface defining the client side end of the IncomingEmailPipe which the user's email client connects to.</p>
 *
 * @see core.IncomingEmailPipe
 */
public abstract interface RecvPipeServerInterface
{
