...
/**
 * <p>Secret keyring asc file format.</p>
 */
public class OpenPGPAscSecretFile extends OpenPGPAscFile {
    
    /** Creates a new instance of OpenPGPAscSecretFile */
    public OpenPGPAscSecretFile() {
    }
    
    /** Creates a new instance of OpenPGPAscSecretFile */
    public OpenPGPAscSecretFile(String filename, KeyHandlerParameters parameters) {
    ...
    public void addKeys(KeyData[] key, KeyIdentifier[] idDetails, KeyHandlerParameters[] parameters) throws KeyHandlerException {
        try {
            ...
            fout.write("-----BEGIN PGP PRIVATE KEY BLOCK-----\r\n".getBytes());
            ...
            out.write(addKeyData(key, idDetails, parameters));
            
            fout.write(Armory.armor(out.toByteArray()).getBytes());
            
            // write tail
            fout.write("-----END PGP PRIVATE KEY BLOCK-----\r\n".getBytes());
    ...
    protected byte [] addKeyData(KeyData[] key, KeyIdentifier[] idDetails, KeyHandlerParameters[] parameters) throws KeyHandlerException {
        try{
