...
/**
 * <p>A class representing a v3 or v4 public key packet.</p>
 */
public class PublicKeyPacket extends KeyPacket {
    
    /** Creates a new instance of PublicKeyPacket. Does not create a header. */
     ...
     */
    public PublicKeyPacket(int expiry, int keyAlgorithm, AsymmetricAlgorithmParameters keyParams) throws AlgorithmException {
        super(expiry, keyAlgorithm, keyParams);
        setPacketHeader(new PacketHeader(6, false, keyParams.encodePublicKeyComponents().length + 8));
    }
     ...
     * @throws AlgorithmException if the packet could not be created.
     */
    public PublicKeyPacket(int keyAlgorithm, AsymmetricAlgorithmParameters keyParams) throws AlgorithmException {
        super(keyAlgorithm, keyParams);
        setPacketHeader(new PacketHeader(6, false, keyParams.encodePublicKeyComponents().length + 6));
    }
     ...
     * @throws AlgorithmException if the packet could not be created.
     */
    public PublicKeyPacket(Date creationdate, int expiry, int keyAlgorithm, AsymmetricAlgorithmParameters keyParams) throws AlgorithmException {
     ...
     * @throws AlgorithmException if the packet could not be created.
     */
    public PublicKeyPacket(Date creationdate, int keyAlgorithm, AsymmetricAlgorithmParameters keyParams) throws AlgorithmException {
