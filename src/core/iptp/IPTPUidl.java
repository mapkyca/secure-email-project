...
/**
 * <p>Request unique server id identifying a message, or all messages if no parameters were set.</p>
 * <p>Expects a multiline response if the command was successful.</p>
 */
public class IPTPUidl extends IPTPCommand {
    
    /** The message to retrieve info on.*/
    private int messageno;
    
    /** Creates a new instance of IPTPUidl */
    public IPTPUidl() {
        setExpectingMultilineResponse(true);
        setMessageNo(-1);
    }

    /** <p>Creates a new instance of IPTPUidl with a given message number (equiv to "uidl x" in POP3).</p>
    * @param messno is the message to retrieve details of. Set to -1 for no parameters or use default contructor.
    */
    public IPTPUidl(int messno) {
        setMessageNo(messno);
