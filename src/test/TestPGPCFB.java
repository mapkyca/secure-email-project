...
/**
 * <p>This is an itterative test to debug a problem with the PGP CFB mode cipher
 * where the decryption will fail for data of certain lengths.</p>
 * <p>Test results will be outputted to a CSV file.</p>
 * <p>Usage: java test.TestPGPCFB itterations filename
 */
public class TestPGPCFB extends Test {
    ...
    /** Creates a new instance of TestPGPCFB */
    public TestPGPCFB(int its, String filename) {
        setTestName("Test PGPCFBwithIV mode"); // name of the test to be printed on the console.
    ...
    public static void main(String[] args) {
        if (args.length <= 1) {
            System.out.println("TestPGPCFB With IV");
            System.out.println();
            ...
            TestPGPCFB t = new TestPGPCFB(Integer.parseInt(args[0]), args[1]);
