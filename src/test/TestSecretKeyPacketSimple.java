...
/**
 * <p>This is a simple test of the Secret key packet.</p>
 * <p>This test creates a rsa key pair, writes some data, saves the key, then attempts to read the key back in and decode the data.</p>
 * <p>Note: Success of this test does not necessarily mean the packets are being generated in a PGP compatible format.</p>
 */
public class TestSecretKeyPacketSimple extends Test {

    public final String passphrase = "test";
    
    /** Filenames */
    public final String keyoutfile = "TestSecretKeyPacketSimple_Key.packet";
    public final String dataoutfile = "TestSecretKeyPacketSimple_data.pgp";
    ...
    /** Creates a new instance of TestSecretKeyPacketSimple */
    public TestSecretKeyPacketSimple() {
        setTestName("Test SecretKeyPacket (simple write)"); // name of the test to be printed on the console.
    }
    ...
    public static void main(String[] args) {
        TestSecretKeyPacketSimple t = new TestSecretKeyPacketSimple();
    ...
    public boolean test() throws Exception {
        ...
        SecretKeyPacket skp = new SecretKeyPacket(PKAlgorithm, SymmetricAlgorithm, new S2K(hashalgorithm, salt), passphrase.getBytes(), params);
