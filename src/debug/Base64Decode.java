...
/**
 * A quick program to decode a given file from base 64 mime encoding.
 */
public class Base64Decode {
    ...
    /** Creates a new instance of Base64Decode */
    public Base64Decode() {
    }
    ...
    public static void main(String[] args) {
        if (args.length <= 1) {
            System.out.println("Base64Decode - Base64 file decoder " + version + " : By Marcus Povey");
            System.out.println();
            System.out.println("Usage: java test.Base64Decode <encodedfile> <outfile> ");
        } else {
            try {
                ...
                byte [] encoded = new byte[r.available()];
                r.read(encoded);
                r.close();
